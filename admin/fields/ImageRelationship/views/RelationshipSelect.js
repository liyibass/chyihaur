...
import "./ImageRelationship.style.css";
  ...
  (
    ...
    const returnSnapshot = () => {
      if (!currentValue["label"]) {
        return (
          <div className='SelectContainer__snapshot_container'>
            <Carousel infiniteLoop showArrows>
              {currentValue.map((image) => {
                return (
                  <img
        ...
        return (
          <div className='SelectContainer__snapshot_container'>
            <img
              src={currentValue.urlOriginal}
              alt={currentValue._label_}
              key={currentValue.urlOriginal}
            />
          </div>
        );
      }
    ...
    return (
      <div className='SelectContainer'>
        <Select
          ...
          {...selectProps}
        />
        <div className='SelectContainer__snapshot'>
          {currentValue ? returnSnapshot() : <h6>Image Preview</h6>}
        </div>
      </div>
    );
  }
